...
void realizarVenta() {
    ...
    long monto_final_iva = precio_total * IVA;
    // PREGUNTAR CONFIRMACIÓN
    ...
    compra.monto_total = monto_final_iva;
    ...
    for (int i = 0; i < cantidad_entradas; i++) {
        ...
        precio_total += pase[i].precio_total;
    ...
    printf(CHAR_MOSTRAR_COMPRA, 
        ...
        precio_total, // precio pases
        monto_final_iva - precio_total, // IVA
        compra_insertada.monto_total, // total con IVA
